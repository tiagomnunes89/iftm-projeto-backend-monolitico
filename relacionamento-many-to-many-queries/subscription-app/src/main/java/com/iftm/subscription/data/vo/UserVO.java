...
public class UserVO implements Serializable {
    ...
    public UserVO(Long id, String firstName, String lastName, String userName, String password, String phone, String socialNetwork, List<Email> emails, List<Group> groups) {
        this.id = id;
